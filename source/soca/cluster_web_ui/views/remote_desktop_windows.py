...
def create():
    ...
    if parameters["instance_ami"] == "base":
        ...
        if instance_type.startswith("g"):
            if region not in dcv_windows_ami["graphics"].keys() and parameters["instance_ami"] == "base":
            ...
            if region not in dcv_windows_ami["non-graphics"].keys() and parameters["instance_ami"] == "base":
